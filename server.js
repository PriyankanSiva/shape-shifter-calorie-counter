...
//response data
  res.json({
    ...
    daily_calorie_burn_by_workout : daily_calorie_burnby_workout ? daily_calorie_burnby_workout : 0,
    daily_calorie_burn_by_cardio : daily_calorie_burnby_cardio ? daily_calorie_burnby_cardio : 0,
